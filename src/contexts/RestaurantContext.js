...
const RestaurantProvider = ({ children }) => {
    ...
    const handleAddItems = (dish) => {
        ...
        if (existingItemIndex !== -1) {
            // If the dish already exists, update the quantity or any other logic
            console.log(
    ...
    const handleRemoveItems = (dish) => {
        ...
        if (existingItemIndex !== -1) {
            // If the dish exists, decrement the quantity or remove it from the cart
            console.log(
            ...
            // If the dish is not in the cart, log a message or handle accordingly
